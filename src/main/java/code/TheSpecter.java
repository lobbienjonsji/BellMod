...
import code.cards.specter_cards.Chime;
import code.cards.specter_cards.Tune;
...
import code.relics.DeathKnell;

import java.util.ArrayList;

import static code.TheSpecter.Enums.SPECTER_LIGHT_BLUE;
import static code.ModFile.*;

public class TheSpecter extends CustomPlayer {

    static final String ID = makeID("TheSpecter");
    static final CharacterStrings characterStrings = CardCrawlGame.languagePack.getCharacterString(ID);
    static final String[] NAMES = characterStrings.NAMES;
    static final String[] TEXT = characterStrings.TEXT;


    public TheSpecter(String name, PlayerClass setClass) {
    ...
    public AbstractPlayer newInstance() {
        return new TheSpecter(name, chosenClass);
    }
    ...
    public static class Enums {
        @SpireEnum
        public static AbstractPlayer.PlayerClass THE_SPECTER;
        @SpireEnum(name = "SPECTER_LIGHT_BLUE")
        public static AbstractCard.CardColor SPECTER_LIGHT_BLUE;
        @SpireEnum(name = "SPECTER_LIGHT_BLUE")
