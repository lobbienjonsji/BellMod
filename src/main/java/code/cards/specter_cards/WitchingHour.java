...
public class WitchingHour extends AbstractEasyCard {
    
    public final static String ID = makeID(WitchingHour.class.getSimpleName());
    ...
    public void use(AbstractPlayer abstractPlayer, AbstractMonster abstractMonster) {
        addToBot(new ApplyPowerAction(abstractPlayer, abstractPlayer, new WitchingHourPower(abstractPlayer, magicNumber)));
    }
}
