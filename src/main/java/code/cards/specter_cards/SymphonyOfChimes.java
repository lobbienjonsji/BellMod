...
public class SymphonyOfChimes extends AbstractEasyCard {
    
    public final static String ID = makeID(SymphonyOfChimes.class.getSimpleName());
    ...
    public void use(AbstractPlayer abstractPlayer, AbstractMonster abstractMonster) {
        addToBot(new ApplyPowerAction(abstractPlayer, abstractPlayer, new SymphonyOfChimesPower(abstractPlayer, magicNumber)));
    }
}
